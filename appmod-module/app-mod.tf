...
resource "google_compute_instance" "kubernetes_proxy_server1" {
  ...
  metadata_startup_script = "sudo apt-get update -y;sudo apt-get install git -y;sudo apt-get install kubectl;sudo apt-get install google-cloud-sdk-gke-gcloud-auth-plugin;git clone https://github.com/mgaur10/security-foundation-solution.git;sudo gcloud container clusters get-credentials ${local.cluster_name} --zone=us-east1 --project=YOUR_PROJECT_ID;sudo kubectl apply -f /security-foundation-solution/appmod-module/release/kubernetes-manifests.yaml;"
...
module "gcloud" {
  ...
  create_cmd_body = "container clusters get-credentials ${local.cluster_name} --zone=${var.network_region} --project=YOUR_PROJECT_ID"
 }
...
resource "null_resource" "image_push" {
  ...
  #  interpreter = ["bash", "-exc"]
    ...
    docker tag gcr.io/google-containers/nginx "gcr.io/YOUR_PROJECT_ID/nginx:latest"
    docker push "gcr.io/YOUR_PROJECT_ID/nginx:latest"
    EOT
  }
...
resource "null_resource" "image_push_ubuntu" {
  ...
  #  interpreter = ["bash", "-exc"]
    ...
    docker tag gcr.io/google-containers/ubuntu@sha256:5746b3b4974d1bd3d4ddbac0373fb71b425f13583797414ffd9d8b547d241f75 "gcr.io/YOUR_PROJECT_ID/ubuntu:latest"
    docker push "gcr.io/YOUR_PROJECT_ID/ubuntu:latest"
    EOT
  }
...
resource "null_resource" "image_push_debian" {
  ...
  #  interpreter = ["bash", "-exc"]
    ...
    docker tag gcr.io/google-containers/debian-base@sha256:3a6ec824717e1ca5bb136ffa3dfbd854f109a0b2b376dd2cf9701d4669778fd2 "gcr.io/YOUR_PROJECT_ID/debian:latest"
    docker push "gcr.io/YOUR_PROJECT_ID/debian:latest"
    EOT
  }
...
resource "google_artifact_registry_repository" "artifact_repo" {
  ...
  format        = "DOCKER"
  kms_key_name  = "projects/YOUR_PROJECT_ID/locations/${var.network_region}/keyRings/${var.keyring_name}/cryptoKeys/${var.crypto_key_name}"
